...
const trustItems = [
  ...
  },
  {
    icon: <FaReceipt />,
    title: "Status jelas",
    desc: "Pesanan bisa dipantau dari halaman cek pesanan.",
  },
  {
    icon: <FaBolt />,
    title: "Alur sat-set",
...
function FooterAccordion({ icon, title, children, defaultOpen = false }) {
  return (
    <details
      open={defaultOpen}
      className="group rounded-2xl border border-gray-800 bg-gray-950/70 p-4 transition-all duration-300 open:border-blue-500/30 open:bg-blue-500/5"
    >
      ...
      <div className="mt-4 border-t border-gray-800 pt-4 text-sm leading-relaxed text-gray-400 animate-[fadeIn_0.25s_ease-out]">
        {children}
      </div>
    </details>
  );
  ...
  return (
    <footer className="relative overflow-hidden border-t border-gray-800 bg-gradient-to-b from-gray-950 to-black text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* TOP SUMMARY */}
        <div className="rounded-3xl border border-gray-800 bg-gray-900/75 p-5 shadow-2xl shadow-black/30 backdrop-blur sm:p-6">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              <Link href="/" className="inline-flex items-center">
                ...
                <span className="ml-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-2 py-1 text-[10px] font-black text-blue-300">
                  .id
                </span>
              </Link>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-gray-400">
                Pilih game, isi ID, bayar, lalu pantau status pesanan. NaXaShop
                dibikin biar proses top up terasa lebih rapi, cepat, dan gampang
                dicek kalau ada kendala.
              </p>
            </div>
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-sm font-black text-white shadow-[0_0_22px_rgba(37,99,235,0.32)] transition-all hover:-translate-y-1 hover:bg-blue-500 sm:w-auto"
            >
              <FaHeadset />
              Chat Admin
            </a>
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-2">
          <FooterAccordion icon={<FaUsers />} title="Tentang Kami">
            <p>
            ...
            <p className="mt-3 text-gray-500">
              Di balik layar, sistem terus dirapihin biar order lebih gampang
              dipantau, kendala lebih cepat dicek, dan customer punya bukti
          ...
          <FooterAccordion icon={<FaGamepad />} title="Kenapa pilih NaXaShop?">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-gray-800 bg-black/20 p-3">
                <p className="text-xs font-black text-white">Simple</p>
                <p className="mt-1 text-[11px] leading-relaxed text-gray-500">
                  Alurnya dibuat pendek biar user gak muter-muter.
                </p>
              </div>

              <div className="rounded-2xl border border-gray-800 bg-black/20 p-3">
                <p className="text-xs font-black text-white">Terlacak</p>
                <p className="mt-1 text-[11px] leading-relaxed text-gray-500">
                  Ada Order ID dan status pesanan yang bisa dicek.
                </p>
              </div>

              <div className="rounded-2xl border border-gray-800 bg-black/20 p-3">
                <p className="text-xs font-black text-white">Dibantu admin</p>
                <p className="mt-1 text-[11px] leading-relaxed text-gray-500">
                  Kalau order butuh dicek ulang, admin bisa bantu lihat detail.
                </p>
              </div>
            </div>
          </FooterAccordion>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              {quickLinks.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  className="rounded-2xl border border-gray-800 bg-gray-950/70 px-4 py-3 text-center text-xs font-black text-gray-400 transition-all hover:-translate-y-1 hover:border-blue-500/40 hover:text-blue-300"
                >
                  {item.label}
                </Link>
              ))}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Pilih metode yang paling cocok sama saldo lu.
                </p>
              </div>

              <div className="flex items-center gap-2 rounded-full border border-green-500/10 bg-green-500/5 px-3 py-2 text-[10px] font-black text-green-300">
                <FaCheckCircle />
                Status terlacak
              </div>
            </div>
        ...
        <div className="mt-6 flex flex-col gap-4 border-t border-gray-800 pt-5 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-2xl border border-gray-700 bg-gray-800 text-white transition-all hover:-translate-y-1 hover:border-blue-400 hover:bg-blue-500"
            >
              <FaInstagram />
            </a>
