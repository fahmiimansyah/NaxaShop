  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h3 className="font-black uppercase tracking-[0.25em] text-blue-400 mb-3">
          NaXaShop Games
        </h3>
      </div>
        ...
        <div className="relative">
          ...
          {kataKunci ? (
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-xl bg-gray-700 hover:bg-blue-600 text-gray-300 hover:text-white text-sm font-black transition-all"
